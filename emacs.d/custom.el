(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nlinum-relative linum-relative helm smooth-scroll evil-indent-textobject evil-surround evil-nerd-commenter evil-numbers solarized-theme evil-jumper evil-leader use-package evil))))
(custom-set-faces
